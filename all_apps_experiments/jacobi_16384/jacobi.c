...
// MOnil #define SIZE  8192 //256 * 48
#define SIZE  4096 //256 * 48
...
void openacc_comp1(float *a, float *b, int m_size) {
	int i;
	int j;
#pragma acc kernels loop gang, worker present(a[0:m_size+2][0:m_size+2], b[0:m_size+2][0:m_size+2])
...
void stencil_jacobi(float (*a_CPU)[SIZE_2], float (*b_CPU)[SIZE_2])
{
int i, j;
