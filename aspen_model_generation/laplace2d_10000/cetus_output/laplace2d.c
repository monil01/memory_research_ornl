...
double A_CPU[10000][10000];
double Anew_CPU[10000][10000];
int main(int argc, char * * argv)
{
#pragma aspen  declare param(n:10000)
int n = 10000;
...
double (* A)[10000] = (double (* )[10000])malloc(((sizeof (double)*n)*n));
#pragma aspen  declare data(Anew:traits(Matrix(n, n)))
double (* Anew)[10000] = (double (* )[10000])malloc(((sizeof (double)*n)*n));
