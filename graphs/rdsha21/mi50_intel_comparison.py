...
plt.plot(stride, read_mi50, marker='o', markersize=10,  color='blue', linestyle='dashed', label="Read - MI50", linewidth=2)
plt.plot(stride, write_mi50, marker='*', markersize=10,  color='blue', linestyle='dashed', label="Write - MI50", linewidth=2)



plt.plot(stride, read, marker='s', markersize=7,  color='black', linestyle='dashdot', label="Read-CPU", linewidth=1.5)
plt.plot(stride, writei, marker='<', markersize=7,  color='black', linestyle='dashdot', label="Write-CPU", linewidth=1.5)
...
plt.show()
fig.savefig('mi100_cpu.png', dpi=100)
