...
double A_CPU[4096][4096];
double Anew_CPU[4096][4096];
int main(int argc, char * * argv)
{
#pragma aspen  declare param(n:4096)
int n = 4096;
...
double (* A)[4096] = (double (* )[4096])malloc(((sizeof (double)*n)*n));
#pragma aspen  declare data(Anew:traits(Matrix(n, n)))
double (* Anew)[4096] = (double (* )[4096])malloc(((sizeof (double)*n)*n));
