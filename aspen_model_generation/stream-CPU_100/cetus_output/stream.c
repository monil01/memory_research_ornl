 ...
 *-----------------------------------------------------------------------
*/
#pragma aspen  declare data(a:traits(Array(100000000, aspen_param_sizeof_float)))
static float a[(100000000+0)];
#pragma aspen  declare data(b:traits(Array(100000000, aspen_param_sizeof_float)))
static float b[(100000000+0)];
#pragma aspen  declare data(c:traits(Array(100000000, aspen_param_sizeof_float)))
static float c[(100000000+0)];
...
static double bytes[4] = {(2*sizeof (float))*100000000, (2*sizeof (float))*100000000, (3*sizeof (float))*100000000, (3*sizeof (float))*100000000};
...
aAvgErr=(aSumErr/((float)100000000));
bAvgErr=(bSumErr/((float)100000000));
cAvgErr=(cSumErr/((float)100000000));
if (sizeof (float)==4)
{
epsilon=1.0E-6;
}
